...
file_names = ["RRF_1.json", "RRF_1_unit2course.json", "RRF_1.25.json", "RRF_1.25_unit2course.json"]
...
plot_bounded_kde(
    ...
    xlabel='MCC', 
    filename='RRF_unit2course_mcc_bounded_kdeplot.png', 
    lower_bound=-1.0, 
    upper_bound=1.0
)
...
plot_bounded_kde(
    ...
    filename='RRF_unit2course_bacc_bounded_kdeplot.png', 
    lower_bound=0.0, 
    upper_bound=1.0
)