...
file_names = ["test_1.json", "test_1_unit2course.json", "test_1.25.json", "test_1.25_unit2course.json"]
...
plot_bounded_kde(
    ...
    xlabel='MCC', 
    filename='test_unit2course_mcc_bounded_kdeplot.png', 
    lower_bound=-1.0, 
    upper_bound=1.0
)
...
plot_bounded_kde(
    ...
    filename='test_unit2course_bacc_bounded_kdeplot.png', 
    lower_bound=0.0, 
    upper_bound=1.0
)